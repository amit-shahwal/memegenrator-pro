...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"upload.js":[function(require,module,exports) {
"use strict";
...
var uploadmeme = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', " uploaded successfully!");
              window.location = '/usermemes';
            }
  ...
  return function uploadmeme(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var uploadmemeopen = document.querySelector(".nav__el--uploadmeme");
var uploadform = document.querySelector(".form-user-data");
var memecount = document.querySelector(".nav__el.nav__el--memec");
...
if (uploadmemeopen) uploadmemeopen.addEventListener("click", function () {
